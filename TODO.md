...
- TTS/Transcript (Text To Speech + Speech To Text interface)
- Webhook master (module to dynamically use and manage webhooks to send messages that look like user (user avatar and nickname)
- Leaderboards (module to list users from most to least in categories like word (who said "dupa" most times and how many times exactly) or gave reaction, or sent/replied/reacted on specific channel, or to specific user etc) (top 10 users or all users) 
